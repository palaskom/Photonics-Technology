%%
clc; close all; clear all; path( pathdef );

% This ExampleScript uses the FD-BPM to study a SOI-waveguide MZI modulator
...
OnOff = 0; % [.] 0=Off, 1=On, other=use_previous dn -- See below!
...
% Alternatively, you can use the FIDODIES (FInite Difference One 
% DImensional Eigenmode Solver) function:
%              [neff,Profile] = FIDODIESv2( wl , x , ns , sx );
% which numerically computes the eigenmodes (neff & profile) supported by 
% ARBITRARY refr-index profile waveguides. This is in contrast to MLSWG
% which only works for STEP-INDEX profiles (i.e. SLABs). For more details,
% refer to the HELP of these functions
